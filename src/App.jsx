...
// --- CALENDRIER COMPLET DE BASE (24 GRANDS PRIX 2026) ---
const INITIAL_CALENDAR_2026 = [
  { round: 1, id: "melbourne", name: "Australian Grand Prix", circuit: "Albert Park Circuit", country: "Australie 🇦🇺", city: "Melbourne", status: "completed", qualiDeadline: "2026-03-07T05:00:00Z", isSprint: false, length: "5.278 km", laps: 58, lapRecord: "1:19.813 (Leclerc, 2024)", officialResults: { pole: "norris", pos1: "norris", pos2: "verstappen", pos3: "leclerc", dotd: "sainz" }, practice: [{ pos: 1, driver: "Norris", team: "McLaren", time: "1:20.102", tire: "SOFT", laps: 18 }, { pos: 2, driver: "Verstappen", team: "Red Bull", time: "1:20.210", tire: "MEDIUM", laps: 24 }] },
  { round: 2, id: "shanghai", name: "Chinese Grand Prix", circuit: "Shanghai International Circuit", country: "Chine 🇨🇳", city: "Shanghai", status: "completed", qualiDeadline: "2026-03-14T07:00:00Z", isSprint: true, length: "5.451 km", laps: 56, lapRecord: "1:32.238 (Schumacher, 2004)", officialResults: { pole: "verstappen", pos1: "verstappen", pos2: "norris", pos3: "leclerc", dotd: "leclerc" }, practice: [] },
  { round: 3, id: "suzuka", name: "Japanese Grand Prix", circuit: "Suzuka Circuit", country: "Japon 🇯🇵", city: "Suzuka", status: "completed", qualiDeadline: "2026-03-28T06:00:00Z", isSprint: false, length: "5.807 km", laps: 53, lapRecord: "1:30.983 (Hamilton, 2019)", officialResults: { pole: "verstappen", pos1: "verstappen", pos2: "perez", pos3: "sainz", dotd: "leclerc" }, practice: [] },
  { round: 4, id: "sakhir", name: "Bahrain Grand Prix", circuit: "Bahrain International Circuit", country: "Bahreïn 🇧🇭", city: "Sakhir", status: "completed", qualiDeadline: "2026-04-11T16:00:00Z", isSprint: false, length: "5.412 km", laps: 57, lapRecord: "1:31.447 (de la Rosa, 2005)", officialResults: { pole: "verstappen", pos1: "verstappen", pos2: "perez", pos3: "sainz", dotd: "sainz" }, practice: [] },
  ...
  { round: 6, id: "miami", name: "Miami Grand Prix", circuit: "Miami International Autodrome", country: "USA 🇺🇸", city: "Miami", status: "completed", qualiDeadline: "2026-05-02T20:00:00Z", isSprint: true, length: "5.412 km", laps: 57, lapRecord: "1:29.708 (Verstappen, 2023)", officialResults: { pole: "verstappen", pos1: "norris", pos2: "verstappen", pos3: "leclerc", dotd: "norris" }, practice: [] },
  { round: 7, id: "montreal", name: "Canadian Grand Prix", circuit: "Circuit Gilles-Villeneuve", country: "Canada 🇨🇦", city: "Montréal", status: "completed", qualiDeadline: "2026-05-23T20:00:00Z", isSprint: false, length: "4.361 km", laps: 70, lapRecord: "1:13.078 (Bottas, 2019)", officialResults: { pole: "russell", pos1: "verstappen", pos2: "norris", pos3: "russell", dotd: "norris" }, practice: [] },
  { round: 8, id: "monaco", name: "Grand Prix de Monaco", circuit: "Circuit de Monaco", country: "Monaco 🇲🇨", city: "Monte-Carlo", status: "completed", qualiDeadline: "2026-06-06T14:00:00Z", isSprint: false, length: "3.337 km", laps: 78, lapRecord: "1:12.909 (Hamilton, 2021)", officialResults: { pole: "leclerc", pos1: "leclerc", pos2: "piastri", pos3: "sainz", dotd: "leclerc" }, practice: [] },
  { round: 9, id: "barcelona", name: "Gran Premio de España (Barcelone)", circuit: "Circuit de Barcelona-Catalunya", country: "Espagne 🇪🇸", city: "Barcelone", status: "completed", qualiDeadline: "2026-06-13T14:00:00Z", isSprint: false, length: "4.657 km", laps: 66, lapRecord: "1:16.330 (Verstappen, 2023)", officialResults: { pole: "norris", pos1: "verstappen", pos2: "norris", pos3: "hamilton", dotd: "norris" }, practice: [{ pos: 1, driver: "Norris", team: "McLaren", time: "1:13.901", tire: "SOFT", laps: 21 }] },
  { round: 10, id: "spielberg", name: "Austrian Grand Prix", circuit: "Red Bull Ring", country: "Autriche 🇦🇹", city: "Spielberg", status: "completed", qualiDeadline: "2026-06-27T14:00:00Z", isSprint: true, length: "4.318 km", laps: 71, lapRecord: "1:05.619 (Sainz, 2020)", officialResults: { pole: "verstappen", pos1: "russell", pos2: "piastri", pos3: "sainz", dotd: "norris" }, practice: [] },
  { round: 11, id: "silverstone", name: "British Grand Prix", circuit: "Silverstone Circuit", country: "Royaume-Uni 🇬🇧", city: "Silverstone", status: "completed", qualiDeadline: "2026-07-04T14:00:00Z", isSprint: false, length: "5.891 km", laps: 52, lapRecord: "1:27.097 (Verstappen, 2020)", officialResults: { pole: "russell", pos1: "hamilton", pos2: "verstappen", pos3: "norris", dotd: "hamilton" }, practice: [] },
  { round: 12, id: "spa", name: "Belgian Grand Prix", circuit: "Circuit de Spa-Francorchamps", country: "Belgique 🇧🇪", city: "Spa", status: "completed", qualiDeadline: "2026-07-18T14:00:00Z", isSprint: true, length: "7.004 km", laps: 44, lapRecord: "1:44.701 (Perez, 2024)", officialResults: { pole: "leclerc", pos1: "hamilton", pos2: "piastri", pos3: "leclerc", dotd: "hamilton" }, practice: [] },
  { round: 13, id: "hungaroring", name: "Hungarian Grand Prix", circuit: "Hungaroring", country: "Hongrie 🇭🇺", city: "Budapest", status: "completed", qualiDeadline: "2026-07-25T14:00:00Z", isSprint: false, length: "4.381 km", laps: 70, lapRecord: "1:16.627 (Hamilton, 2020)", officialResults: { pole: "norris", pos1: "piastri", pos2: "norris", pos3: "hamilton", dotd: "piastri" }, practice: [] },
  { round: 14, id: "zandvoort", name: "Dutch Grand Prix", circuit: "Circuit Zandvoort", country: "Pays-Bas 🇳🇱", city: "Zandvoort", status: "completed", qualiDeadline: "2026-08-22T13:00:00Z", isSprint: false, length: "4.259 km", laps: 72, lapRecord: "1:11.097 (Hamilton, 2021)", officialResults: { pole: "norris", pos1: "norris", pos2: "verstappen", pos3: "leclerc", dotd: "norris" }, practice: [] },
  { round: 15, id: "monza", name: "Gran Premio d'Italia (Monza)", circuit: "Autodromo Nazionale Monza", country: "Italie 🇮🇹", city: "Monza", status: "completed", qualiDeadline: "2026-09-05T14:00:00Z", isSprint: false, length: "5.793 km", laps: 53, lapRecord: "1:21.046 (Barrichello, 2004)", officialResults: { pole: "norris", pos1: "leclerc", pos2: "piastri", pos3: "norris", dotd: "leclerc" }, practice: [{ pos: 1, driver: "Hamilton", team: "Ferrari", time: "1:20.738", tire: "SOFT", laps: 24 }] },
  { round: 16, id: "madrid", name: "Gran Premio de Madrid (Madring)", circuit: "Madring IFEMA Circuit", country: "Espagne 🇪🇸", city: "Madrid", status: "completed", qualiDeadline: "2026-09-12T14:00:00Z", isSprint: false, length: "5.474 km", laps: 55, lapRecord: "1:18.200 (Sainz, 2026)", officialResults: { pole: "sainz", pos1: "sainz", pos2: "leclerc", pos3: "alonso", dotd: "alonso" }, practice: [{ pos: 1, driver: "Sainz", team: "Williams", time: "1:18.510", tire: "SOFT", laps: 22 }] },
  { round: 17, id: "baku", name: "Azerbaijan Grand Prix (Bakou)", circuit: "Baku City Circuit", country: "Azerbaïdjan 🇦🇿", city: "Bakou", status: "active", qualiDeadline: new Date(Date.now() + (2 * 24 * 60 + 4 * 60) * 60 * 1000).toISOString(), isSprint: false, length: "6.003 km", laps: 51, lapRecord: "1:43.009 (Leclerc, 2019)", officialResults: null, practice: [{ pos: 1, driver: "Leclerc", team: "Ferrari", time: "1:42.980", tire: "SOFT", laps: 17 }, { pos: 2, driver: "Piastri", team: "McLaren", time: "1:43.112", tire: "SOFT", laps: 19 }, { pos: 3, driver: "Hadjar", team: "Red Bull", time: "1:43.405", tire: "HARD", laps: 28 }] },
  { round: 18, id: "singapore", name: "Singapore Grand Prix", circuit: "Marina Bay Street Circuit", country: "Singapour 🇸🇬", city: "Marina Bay", status: "upcoming", qualiDeadline: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000).toISOString(), isSprint: false, length: "4.940 km", laps: 62, lapRecord: "1:34.486 (Ricciardo, 2024)", officialResults: null, practice: [] },
  { round: 19, id: "austin", name: "United States Grand Prix", circuit: "Circuit of the Americas", country: "USA 🇺🇸", city: "Austin", status: "upcoming", qualiDeadline: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000).toISOString(), isSprint: true, length: "5.513 km", laps: 56, lapRecord: "1:36.169 (Leclerc, 2019)", officialResults: null, practice: [] },
  { round: 20, id: "mexico", name: "Gran Premio de la Ciudad de México", circuit: "Autódromo Hermanos Rodríguez", country: "Mexique 🇲🇽", city: "Mexico", status: "upcoming", qualiDeadline: new Date(Date.now() + 35 * 24 * 60 * 60 * 1000).toISOString(), isSprint: false, length: "4.304 km", laps: 71, lapRecord: "1:17.774 (Bottas, 2021)", officialResults: null, practice: [] },
  { round: 21, id: "saopaulo", name: "Grande Prêmio de São Paulo", circuit: "Autódromo de Interlagos", country: "Brésil 🇧🇷", city: "São Paulo", status: "upcoming", qualiDeadline: new Date(Date.now() + 42 * 24 * 60 * 60 * 1000).toISOString(), isSprint: true, length: "4.309 km", laps: 71, lapRecord: "1:10.540 (Bottas, 2018)", officialResults: null, practice: [] },
  { round: 22, id: "lasvegas", name: "Las Vegas Grand Prix", circuit: "Las Vegas Strip Circuit", country: "USA 🇺🇸", city: "Las Vegas", status: "upcoming", qualiDeadline: new Date(Date.now() + 55 * 24 * 60 * 60 * 1000).toISOString(), isSprint: false, length: "6.201 km", laps: 50, lapRecord: "1:35.490 (Piastri, 2023)", officialResults: null, practice: [] },
  { round: 23, id: "lusail", name: "Qatar Grand Prix", circuit: "Lusail International Circuit", country: "Qatar 🇶🇦", city: "Lusail", status: "upcoming", qualiDeadline: new Date(Date.now() + 63 * 24 * 60 * 60 * 1000).toISOString(), isSprint: true, length: "5.419 km", laps: 57, lapRecord: "1:24.319 (Verstappen, 2023)", officialResults: null, practice: [] },
  { round: 24, id: "abudhabi", name: "Abu Dhabi Grand Prix (Finale)", circuit: "Yas Marina Circuit", country: "Émirats Arabes Unis 🇦🇪", city: "Yas Island", status: "upcoming", qualiDeadline: new Date(Date.now() + 70 * 24 * 60 * 60 * 1000).toISOString(), isSprint: false, length: "5.281 km", laps: 58, lapRecord: "1:26.103 (Verstappen, 2021)", officialResults: null, practice: [] }
];
...
export default function App() {
  ...
  // Synchronisation avec l'API Jolpica F1
  const syncWithF1Api = async () => {
    setIsApiSyncing(true);
    try {
      const apiRaces = await fetchOfficialCalendar();
  ...
  // 1. Initialisation API et session Supabase
  useEffect(() => {
    syncWithF1Api();
  ...
  return (
    <div className="min-h-screen bg-[#0e0e14] text-white flex flex-col font-sans">
      {/* HEADER SPORTIF RESPONSIVE AVEC BADGE VERSION ALPHA v3 */}
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {/* Badge Version Discret ALPHA v3 */}
              ...
              <div className="flex items-center gap-2 mt-0.5">
                {isAdmin && (
                  <span className="text-[9px] bg-amber-500/20 text-amber-400 border border-amber-500/40 px-1.5 py-0.2 rounded font-mono inline-flex items-center gap-1">
                    <ShieldAlert className="w-2.5 h-2.5" /> SUPERVISEUR
                  </span>
                )}
                {apiStatus.synced && (
                  <span className="hidden sm:inline text-[9px] text-zinc-500 font-mono">
                    API F1 sync {apiStatus.lastUpdate}
                  </span>
                )}
              </div>
            </div>
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto p-4 sm:p-6 space-y-6">
        {activeTab === "bet" && (
          <>
            ...
            <div className="bg-[#1e1e2d] border border-[#2b2b3d] rounded-2xl p-5 shadow-2xl relative overflow-hidden">
                ...
                <div className="bg-[#15151e] border border-[#2b2b3d] p-3.5 rounded-xl flex items-center gap-4 shrink-0">
                  ...
                  <div>
                    <div className="text-[10px] uppercase font-bold text-zinc-400">
                      Compte à rebours {currentGP.isSprint ? "Qualif GP (Samedi)" : "Qualifications"}
                    </div>
                    {isExpired ? (
              ...
              <div className="mt-4 pt-4 border-t border-[#2b2b3d] flex flex-col md:flex-row items-center gap-4">
                ...
                <div className="w-full md:w-1/3 text-xs space-y-2 bg-[#15151e] p-3 rounded-lg border border-[#2b2b3d]">
                  ...
                  {currentGP.isSprint && (
                    <div className="pt-1 border-t border-[#2b2b3d] text-[11px] text-amber-400">
                      * Paris fermés avant la Qualification du Samedi.
                    </div>
                  )}
                </div>
              </div>
            ...
            {/* ACCORDÉON ESSAIS LIBRES (FP3/FP1 & GOMMES DE PNEUS) */}
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-sm text-white">
                    Tendances Essais Libres ({currentGP.isSprint ? "FP1 Sprint" : "FP3"} & Gommes de Pneus)
                  </span>
                </div>
        ...
        {activeTab === "history" && (
          <div className="bg-[#1e1e2d] border border-[#2b2b3d] rounded-2xl p-5 shadow-2xl space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={syncWithF1Api}
                disabled={isApiSyncing}
                className="text-xs bg-[#15151e] border border-[#2b2b3d] px-2.5 py-1.5 rounded-lg text-zinc-300 hover:text-white flex items-center gap-1.5"
              >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">Homologation des résultats et synchronisation API pour {currentGP.name}</p>
                </div>
              </div>
              ...
              <button
                onClick={syncWithF1Api}
                disabled={isApiSyncing}
                className="bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/50 text-amber-300 text-xs font-bold px-3 py-2 rounded-xl flex items-center gap-2 self-start sm:self-center transition"
              >
                <RefreshCw className={`w-3.5 h-3.5 ${isApiSyncing ? "animate-spin" : ""}`} />
                <span>Actualiser via API F1</span>
              </button>
            </div>
      ...
      <footer className="bg-[#15151e] border-t border-[#2b2b3d] py-4 text-center text-xs text-zinc-500">
        F1 Paddock Bets 2026 • {APP_VERSION} • Synchronisé avec Jolpica F1 API • Déployé sur Vercel & Supabase
      </footer>
    </div>
  );
}